            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        var $role = full['role'];
                        var roleBadgeObj = {
                            Member: '<i class="ri-user-line ri-22px text-success me-2"></i>',
                            Moderator: '<i class="ri-pie-chart-line ri-22px text-info me-2"></i>',
            ...
            initComplete: function () {
                ...
                this.api()
                    ...
                    .every(function () {
                        ...
                        // Use string directly from data (no need for statusObj)
                        column
                            .data()
                            .unique()
                            .sort()
                            .each(function (statusValue) {
                                select.append(
                                    '<option value="' +
                                    statusValue +
