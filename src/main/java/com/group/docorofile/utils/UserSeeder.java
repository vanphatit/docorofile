    ...
    public void seedUsers() {
        if (userRepository.count() == 0) {
            ...
            MemberEntity member1 = MemberEntity.builder()
                    ...
                    .build();
            member1.setProfileValue("firstname", "Alice");
            member1.setProfileValue("lastname", "Nguyen");
            member1.setProfileValue("studyat", "Ho Chi Minh City University of Technology");
...
//            // ===== MEMBER 2 =====
            ...
            MemberEntity member2 = MemberEntity.builder()
                    ...
                    .build();
            member2.setProfileValue("firstname", "Bob");
            member2.setProfileValue("lastname", "Tran");
            member2.setProfileValue("studyat", "Posts and Telecommunications Institute of Technology");
            ...
            MemberEntity member3 = MemberEntity.builder()
                    ...
                    .build();
            member3.setProfileValue("firstname", "Charlie");
            member3.setProfileValue("lastname", "Le");
            member3.setProfileValue("studyat", "University of Information Technology");
            ...
            MemberEntity member13 = MemberEntity.builder()
                    ...
                    .build();
            member13.setProfileValue("firstname", "Mia");
            member13.setProfileValue("lastname", "Tran");
            member13.setProfileValue("studyat", "University of Information Technology");
